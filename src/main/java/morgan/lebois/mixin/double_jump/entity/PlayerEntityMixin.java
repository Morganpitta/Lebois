...
import morgan.lebois.powers.DoubleJumpPowerType;
...
public abstract class PlayerEntityMixin extends LivingEntity implements DoubleJump {
    ...
    public int lebois$getMaxDoubleJumps(){
        return DoubleJumpPowerType.getMaxDoubleJumps((PlayerEntity) (Object) this);
    }

    public double lebois$getDoubleJumpHeight(){
        return DoubleJumpPowerType.getDoubleJumpHeight((PlayerEntity) (Object) this);
    }

    public int lebois$getDoubleJumps(){
        return LeboisEntityComponents.DOUBLE_JUMP.get(this).getDoubleJumps();
    }

    public void lebois$setDoubleJumps(int doubleJumps){
        LeboisEntityComponents.DOUBLE_JUMP.get(this).setDoubleJumps(doubleJumps);
    }

    public boolean lebois$canDoubleJump(){
        return (DoubleJumpPowerType.canDoubleJump((PlayerEntity) (Object)this) && lebois$getDoubleJumps() > 0 && !this.isOnGround() && !this.isFallFlying());
    }
    ...
    public void lebois$doubleJump() {
        ...
        this.lebois$setDoubleJumps(this.lebois$getDoubleJumps() - 1);
