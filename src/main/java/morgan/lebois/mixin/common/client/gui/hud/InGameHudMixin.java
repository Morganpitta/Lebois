package morgan.lebois.mixin.common.client.gui.hud;

import morgan.lebois.Lebois;
import morgan.lebois.powers.DisableHungerPowerType;
import morgan.lebois.powers.SpeedometerPowerType;
...
public abstract class InGameHudMixin {
    ...
    @Unique
    private static final Identifier FOOD_DISABLED_TEXTURE = Lebois.id("hud/food_disabled");
