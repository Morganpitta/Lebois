...
public class GrappleHookEntity extends Entity implements Ownable {
    ...
    public void tick() {
        ...
        if (owner == null || owner.isDead() || owner.isRemoved()) {
            if (owner != null) {
                ((Grapple) (Object) owner).lebois$setGrappleHook(null);
            }
    ...
    public void onTrackedDataSet(TrackedData<?> data) {
        if (OWNER_ID.equals(data)) {
            ...
            if ( this.owner != null && ((Grapple) this.owner).lebois$getGrappleHook() == null) ((Grapple) this.owner).lebois$setGrappleHook(this);
        }
    ...
    public void onRemoved() {
        if (owner instanceof Grapple grappleOwner && grappleOwner.lebois$getGrappleHook() == this) {
            grappleOwner.lebois$setGrappleHook(null);
        }
        super.onRemoved();
    }
