...
public class GrappleEntityActionType extends EntityActionType {
    ...
    public void accept(EntityActionContext context) {
        ...
        player.lebois$grapple(this.maxDistance, this.minDistance, this.disableFallDamage, this.pullSpeed, this.lookAssist, this.damping);
    }

    @Override
    public @NotNull ActionConfiguration<?> getConfig() {
        return LeboisActionTypes.GRAPPLE;
    }
}