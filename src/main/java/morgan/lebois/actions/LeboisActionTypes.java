...
import morgan.lebois.actions.bientity.PossessBiEntityActionType;
import morgan.lebois.actions.entity.*;

public class LeboisActionTypes {
    ...
    public static <T extends EntityActionType> ActionConfiguration<T> registerEntityAction(String path, TypedDataObjectFactory<T> dataFactory) {
        ActionConfiguration<T> configuration = ActionConfiguration.of(Lebois.id(path), dataFactory);
