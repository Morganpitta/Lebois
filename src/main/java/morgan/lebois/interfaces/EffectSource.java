...
public interface EffectSource {
    ...
    @Nullable EffectSource.Source lebois$getStatusEffectSource(RegistryEntry<StatusEffect> statusEffect);
    void lebois$setStatusEffectSource(RegistryEntry<StatusEffect> statusEffect, @Nullable EffectSource.Source source);
}
