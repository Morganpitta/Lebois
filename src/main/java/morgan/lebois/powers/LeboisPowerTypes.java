...
public class LeboisPowerTypes {
    ...
    public static final PowerConfiguration<PreventSelfRenderPowerType> PREVENT_SELF_RENDER = registerConditionedSimple("prevent_self_render", PreventSelfRenderPowerType::new);
