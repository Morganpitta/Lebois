...
public class LesbosC2SPackets {
    public static void register() {
        ...
        PayloadTypeRegistry.playC2S().register(PossessionInputC2SPacket.ID, PossessionInputC2SPacket.CODEC);
        ...
        ServerPlayNetworking.registerGlobalReceiver(PossessionInputC2SPacket.ID, PossessionInputC2SPacket::handle);
    }
}
